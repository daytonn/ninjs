...
jQuery.extend({
	...
	find: function( t, context ) {
		...
		// Continue while a selector expression is_defined, and while
		...
		while ( t && last != t ) {
			...
			// If a selector string still is_defined
			if ( t ) {
...
jQuery.event = {
	...
	fix: function(event) {
		...
		event.preventDefault = function() {
			// if preventDefault is_defined run it on the original event
		...
		event.stopPropagation = function() {
			// if stopPropagation is_defined run it on the original event

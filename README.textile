...
For development, clone the "Github repository":https://github.com/textnotspeech/ninjs and add bin/ninjs to your path (or my favorite trick which is to put it in my development folder and make symbolic link in /usr/local/bin):
...
<pre name="code" class="brush: bash;">ninjs create myapplication</pre>
